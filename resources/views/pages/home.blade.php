...
@section('content')
    ...
    <div class="container-fluid" id="oNama">
        ...
        <div class="row flex3">
            <div class="col-10 col-md-3 blokONama">
                ...
                <div>
                    <h3>Vizija</h3>
                    <p>Vizija kompanije Mobile shop je da pruži najviši nivo usluge na domaćem tržištu uz stalne
                        inovacije i obogaćivanje proizvodnog asortimana.</p>
                </div>
            </div>
            <div class="col-10 col-md-3 blokONama">
                ...
                <div>
                    <h3>Kompanija</h3>
                    <p>Od svog osnivanja 2005. godine, kompanija Mobile shop je jedan od lidera na tržištu tehnike u
                        Srbiji.</p>
                </div>
            </div>
            <div class="col-10 col-md-3 blokONama">
                ...
                <div>
                    ...
                    <p>Mobile shop maloprodajna mreža pokriva preko 25 gradova širom Srbije. Mobile shop ima i Call
                        Centar koji je na raspolaganju kupcima.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row flex">
            <div class="col-12 col-md-5 blokKontakt">
                ...
                <form id="formaKontakt" action="#" method="POST" onSubmit="return provera();">
                    ...
                    <span id="greskaEmail"
                          class="greska">Pogrešno unet email <br/> <i>Format (standardan format)</i></span>
            ...
            <div class="col-12 col-md-6 blokKontakt">
                <div class="flex2">
                    <div class="col-12 mb-4" id="anketa">
                        @foreach($odgovori as $odgovor)
                            <input type="radio" id="id_odgovor" value="{{$odgovor->id}}"/> {{$odgovor->odgovor}} </br>
                        @endforeach
                        <button type="button" onclick="dodajAnketu()">Potvrdi</button>
                    </div>
                    <div id="feedback"></div>
    ...
    <div class="container-fluid" id="mapa">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2830.7511505001744!2d20.457362115498128!3d44.806259879098754!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475a7aa848ddc625%3A0x36e7d5f2cd3e83eb!2z0J3QtdC80LDRmtC40L3QsCAxMCwg0JHQtdC-0LPRgNCw0LQ!5e0!3m2!1ssr!2srs!4v1581967024124!5m2!1ssr!2srs"
